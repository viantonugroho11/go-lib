...
- **consumer:** skip `headersFromMessage` allocation entirely when the message carries no headers, or when neither `WithHeaderKeys` was set nor tracing is active. Fast path avoids the []Header conversion.
